<script>
  ...
  import Lecture24 from './components/Lecture24.svelte';
  ...
  const lectures = [
    ...
    { id: 'lecture24', title: 'Lecture 24 – Correlation', component: Lecture24, questions: ['What is correlation?', 'What is a scatterplot?'] }
  ];
</script>
